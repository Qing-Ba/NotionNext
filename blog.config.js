...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'LiQingBa', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的干饭人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.liqingba.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion,blog,博客,LiQingBa,李清霸', // 网站关键词 英文逗号隔开
  ...
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || 'https://raw.githubusercontent.com/Qing-Ba/NotionNext/refs/heads/main/public/favicon.ico', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  ...
  WIDGET_PET_LINK:
    ...
    'https://raw.githubusercontent.com/imuncle/live2d/refs/heads/master/model/snow_miku/model.json', // 挂件模型地址 @see https://github.com/xiazeyu/live2d-widget-models
  ...
  MUSIC_PLAYER_METING_ID:
    process.env.NEXT_PUBLIC_MUSIC_PLAYER_METING_ID || '6887739224', // 对应歌单的 id
  ...
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || '一个清新的心灵港湾', // 站点描述，被notion中的页面描述覆盖
