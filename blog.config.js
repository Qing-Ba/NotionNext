...
const BLOG = {
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://liqingba.com', // 网站地址
  ...
  RANDOM_IMAGE_URL: process.env.NEXT_PUBLIC_RANDOM_IMAGE_URL || 'https://api.lolicon.app/setu/v2', // 随机图片API,如果未配置下面的关键字，主页封面，头像，文章封面图都会被替换为随机图片
